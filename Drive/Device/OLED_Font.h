...
/*宽8像素，高16像素，包含ASCII，1.3可用*/
const unsigned char F8X16_1_3[] = {
...
// 宽6像素，高8像素，包含ASCII,1.3寸可用
const unsigned char F6x8_1_3[][6] = {
...
// 16*16的点阵字体取模方式：共阴——列行式——逆向输出,1.3寸可用
unsigned char F16x16_1_3[] = {
...
// OLED显示MP3界面（BMP位图）,1.3寸可用
unsigned char BMP1_1_3[] =
    {

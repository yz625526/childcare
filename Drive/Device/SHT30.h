...
#else
        u16 AlertPending : 1; // bit-order is big endian
        u16 Reserve3 : 1;
        u16 HeaterStatus : 1;
        u16 Reserve2 : 1;
        u16 RH_Alert : 1;
...
etError SHT3X_GetTempAndHumi(float *temperature, float *humiditiy,
                             etRepeatability repeatability, etMode mode, u8 timeout);
...
etError SHT3X_GetTempAndHumiClkStretch(float *temperature, float *humiditiy,
                                       etRepeatability repeatability, u8 timeout);
...
etError SHT3X_SetAlertLimits(float humidityHighSet, float temperatureHighSet,
                             float humidityHighClear, float temperatureHighClear, float humidityLowClear, float temperatureLowClear, float humidityLowSet, float temperatureLowSet);
